...
class SEMSegmentation(Dataset):
    ...
    def __init__(self,
                 args,
                 base_dir=Path.db_root_dir('samsung_SEM'),
                 split='train',
                 ):
        """
    ...
    def __getitem__(self, index):
        _cad_img, _sem_img, _target = self._make_img_gt_point_pair(index)
    ...
    def _make_img_gt_point_pair(self, index):
        ...
        return _cad_img, _sem_img, _target

    def transform_tr(self, sample):
        composed_transforms = transforms.Compose([
            tr.RandomColorJitter(),
            #tr.CAD_SEM_merge(alpha=0.1),
    ...
    def transform_val(self, sample):
        ...
        composed_transforms = transforms.Compose([
            tr.RandomCrop(base_size=self.args.base_size, crop_size=self.args.crop_size),
            tr.Normalize(mean=(127.5, 127.5, 127.5), std=(127.5, 127.5, 127.5)),
            #tr.Normalize(mean=(91.83596353, 101.91165835, 91.83596353), std=(26.17432125, 26.88723151, 26.17432125)),
